 ...
 * @private
 */
function findVolumeFromWallet(pricepoints, wallet) {
  var totalVolume  = 0
    , totalSpent   = 0
    , price
    , volume
 ...
 * wallet size and depth. 
 * @param {Object} depth is the price depth info
 * @params {Numeric} wallet is the money you want to spend
 * @returns {Numeric} the volume you can buy
 */
exports.volumeToBuy = function(depth, wallet) {
  return findVolumeFromWallet(depth.asks, wallet);
}

/**
 * Returns the volume you get for selling based
 * on the wallet size and depth.
 * @param {Object} depth is the price depth info
 * @param {Numeric} wallet is the money you have to sell
 * @return {Numeric} the volume you get fom selling
 */
exports.volumeToSell = function(depth, wallet) {
  return findVolumeFromWallet(depth.bids, wallet);
}
